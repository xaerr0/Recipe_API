...
public class RecipeApiApplicationTests {
	...
	public void testGetRecipeByIdSuccessBehavior() throws Exception {
		...
		mockMvc.perform(get("/recipes/" + recipeId))
				...
				.andExpect(jsonPath("reviews", IsCollectionWithSize.hasSize(1)))
				.andExpect(jsonPath("ingredients", IsCollectionWithSize.hasSize(1)))
				.andExpect(jsonPath("steps", IsCollectionWithSize.hasSize(2)));
	}
	...
	public void testGetRecipeByIdFailureBehavior() throws Exception {
		...
		mockMvc.perform(get("/recipes/" + recipeId))
				...
				.andExpect(content().string(Matchers.containsString("No recipe with ID " + recipeId + " could be found")));
	}
	...
	public void testCreateNewRecipeSuccessBehavior() throws Exception {
		...
		MockHttpServletResponse response =
				this.mockMvc.perform(post("/recipes")
						...
						.andExpect(header().string("Location", Matchers.containsString("http://localhost/recipes/")))
	...
	public void testUpdateRecipeSuccessBehavior() throws Exception {
		...
		mockMvc.perform(patch("/recipes")
				...
				.andExpect(jsonPath("$.steps", IsCollectionWithSize.hasSize(3)))
				//and expect 2 ingredients
				.andExpect(jsonPath("$.ingredients", IsCollectionWithSize.hasSize(2)))
